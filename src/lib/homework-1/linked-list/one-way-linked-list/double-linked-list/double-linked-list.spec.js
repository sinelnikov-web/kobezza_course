...
describe('One way double linked list implementation', function () {
    it('Push items into list', function () {
        ...
        expect((_e = (_d = (_c = list.first) === null || _c === void 0 ? void 0 : _c.next) === null || _d === void 0 ? void 0 : _d.next) === null || _e === void 0 ? void 0 : _e.value).toBe(3);
    });
    it('Pop items from list', function () {
        ...
        expect((_e = list.last) === null || _e === void 0 ? void 0 : _e.value).toBe(2);
        list.pop();
        list.pop();
    ...
    it('Unshift items into list', function () {
        ...
        expect((_e = (_d = (_c = list.first) === null || _c === void 0 ? void 0 : _c.next) === null || _d === void 0 ? void 0 : _d.next) === null || _e === void 0 ? void 0 : _e.value).toBe(1);
    });
